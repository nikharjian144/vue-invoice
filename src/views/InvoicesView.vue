                                            ...
                                            <table class="table" style="margin: 0; border: none;">
                                                ...
                                                <tr>
                                                    <td style="border: none; color: gray;" align="right">
                                                        ...
                                                        <span style="float: right; width: 41%">
                                                            <input type="date" class="form-control" v-model="invoice.due_date">
                                                        </span>
                                                    </td>
                                                </tr>
                                                <tr>
                                ...
                                <table class="table" style="margin: 0; border: none;">
                                    <tr>
                                        <td style="border: none; color: gray;" width="50%" align="left">
                                            <span>Notes</span><br>
                                            <span>
                                                <textarea class="form-control" rows="4" v-model="invoice.notes"></textarea>
                                            </span>
                                        </td>
                                ...
                                <table class="table" style="margin: 0; border: none;">
                                    <tr>
                                        <td style="border: none; color: gray;" width="50%" align="left">
                                            <span>Terms</span><br>
                                            <span>
                                                <textarea class="form-control" rows="4" v-model="invoice.terms_and_conditions"></textarea>
                                            </span>
                                        </td>
                                        <td style="border: none;" align="right">
                                            <table width="70%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right" style="border: none;">
                                                        <input type="number" class="form-control" v-model="invoice.amount_paid" style="float: left; width: 84%;">
                                                        <span>US$</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td align="right" style="border: none;">
                                                        {{ decimalDigits(grandTotal - invoice.amount_paid) }}
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
...
<script>
    export default {
        ...
        data() {
            return {
                invoice: {
                    ...
                    ship_to: "",
                    items: [
                        { description: 'Item', quantity: 0, price: 0 },
                    ],
                    invoiceCurrency: {
                        "symbol": "US$",
                        "decimal_digits": 2,
        ...
        methods: {
            addNewItem: function() {
                this.invoice.items.push(
                    { description: 'Item ' + (this.invoice.items.length + 1), quantity: 0, price: 0 }
                )
            },
        ...
        computed: {
            ...
            taxTotal: function() {
                var total = (this.subTotal) * (this.invoice.tax_percent / 100);
                return total;
            },
            grandTotal: function() {
