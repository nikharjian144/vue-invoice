            ...
            <div id="invoice-app" class="text-center border">
                ...
                <div>
                    ...
                    <select id="currency-picker" v-model="invoiceCurrency">
                        <option v-for="currency in currencies" :value="currency" :key="currency.symbol">{{ currency.code }} - {{ currency.name }}</option>
                    </select>
                </div>
    ...
    data() {
      return {
        invoiceCurrency: {
              ...
              currencies: [{"symbol":"$","name":"US Dollar","symbol_native":"$","decimal_digits":2,"rounding":0,"code":"USD","name_plural":"US dollars"},{"symbol":"CA$","name":"Canadian Dollar","symbol_native":"$","decimal_digits":2,"rounding":0,"code":"CAD","name_plural":"Canadian dollars"}],
              company: {
